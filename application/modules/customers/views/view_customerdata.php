...
<body>
    <div class="container bg-white p-3">
        ...
        <div class="mt-3 p-3" style="border:solid #ccc 1px; background-color:#F8F8FF;">
            ...
            <!-- Chose Company -->
            <input hidden type="text" name="forcrf_company_view" id="forcrf_company_view" value="<?php echo $result->crfcus_area?>">
            ...
            <div class="row form-group p-2">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input readonly type="text" name="crf_salesreps_view" id="crf_salesreps_view" class="form-control form-control-sm" value="<?php echo $result->crfcus_salesreps?>">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-4 form-group">
                    ...
                    <input readonly type="text" name="crf_cuscompanycreate_view" id="crf_cuscompanycreate_view" class="form-control form-control-sm" value="<?php echo conDateFromDb($result->crfcus_comdatecreate);?>">
                </div>
            </div>
            ...
            <input hidden type="text" name="forcrf_addresstype_view" id="forcrf_addresstype_view" value="<?php echo $result->crfcus_addresstype?>">
            <div class="row form-group">
                <div class="col-md-4">
            ...
            <div class="row form-group">
                <div class="col-md-12">
                    <textarea readonly name="crf_addressname_view" id="crf_addressname_view" cols="30" rows="3" class="form-control"><?php echo $result->crfcus_address?></textarea>
                </div>
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-md-3" style="<?php echo $mapurldisplay?>">
                    <label for="">แผนที่ (ลิ้งจาก Googlemap) : </label>
                    <a href="<?php echo $result->crfcus_mapurl?>" target="_blank"><span><i class="fas fa-map-marked-alt" style="font-size:28px;color:green;"></i></span></a>
                </div>
            ...
            ?>
                    <div class="col-md-3" style="<?php echo $display?>">
                        ...
                        <a id="mapfilelink" href="#" data-toggle="modal" data-target="#showmapfile" data_mapfile = "<?php echo $image?>"><span><i class="fas fa-map-marked-alt" style="font-size:28px;color:orange;"></i></span></a>
                    </div>
            </div><br>
            ...
            <div class="row form-group">
                <div class="col-md-4 form-group crf_file1">
                    ...
                    <!-- <span><a id="datafile1" href="#" data-toggle="modal" data-target="#show_file1" data_file1="<?php echo $result->crfcus_file1?>"><b><?php echo $result->crfcus_file1?></b></a></span> -->
                ...
                <div class="col-md-4 crf_file6">
                    ...
                    <!-- <span><a id="datafile6" href="#" data-toggle="modal" data-target="#show_file6" data_file6="<?php echo $result->crfcus_file6?>"><b><?php echo $result->crfcus_file6?></b></a></span> -->
